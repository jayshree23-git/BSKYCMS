...
@ToString
@Entity
@Table(name = "HEALTHDEPARTMENTBASICDETAILS_AADHARAAUTH_OLD_LOG")
public class HealthDepartmentBasicDetailsAadharaAuthOldLog {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "HEALTHDEPARTMENTBASICDETAILS_AADHARAAUTH_OLD_LOG_id_gen")
    @SequenceGenerator(name = "HEALTHDEPARTMENTBASICDETAILS_AADHARAAUTH_OLD_LOG_id_gen", sequenceName = "HEALTHDEPARTMENTBASICDETAILS_AADHARAAUTH_OLD_LOG_SEQ", allocationSize = 1)
