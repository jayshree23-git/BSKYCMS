 ...
 */
@Entity
@Table(name = "OLD_PYMNT_FRZ_REPORT_LOG")
public class OldPaymentFreezeReportLog {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_OLD_PYMNT_FRZ_REPORT_LOG_ID")
	@SequenceGenerator(name = "SEQ_OLD_PYMNT_FRZ_REPORT_LOG_ID", sequenceName = "SEQ_OLD_PYMNT_FRZ_REPORT_LOG_ID", allocationSize = 1)
	@Column(name = "PAYMENT_FRZ_LOG_ID")
	...
	public String toString() {
		return "OldPaymentFreezeReportLog [logId=" + logId + ", userId=" + userId + ", fileName=" + fileName
